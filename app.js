...
app.get("/", function(req, res){
  ...
  Post.find({}, function(err, docs){
    if(err) {
      ...
      res.render('home', {content:homeStartingContent, postsPage:docs});
    }
  });
...
app.get('/posts/:postName', function (req, res) {
  const route = _.lowerCase(req.params.postName);
  ...
  Post.find({}, function(err, docs){
    if (err) {
      ...
      docs.forEach(function(post){
        ...
        if (postTitle = route) {
          res.render("post",{titlePost: postTitle, bodyPost: post.body})
        };
      });
...
app.post("/compose", function(req,res){
    const titleText = req.body.postTitle;
